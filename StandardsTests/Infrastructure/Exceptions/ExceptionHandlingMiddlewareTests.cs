...
namespace Standards.CQRS.Tests.Infrastructure.Exceptions;
...
public class ExceptionHandlingMiddlewareTests
{
    ...
    public async Task Invoke_WhenStandardsException_ShouldReturnCustomStatusCode()
    {
        // Arrange
        var httpContext = new DefaultHttpContext();
        var standardsException = new StandardsException(StatusCodeByError.BadRequest, "Standards error", "Standards error", true);
        _nextMock.Setup(next => next(It.IsAny<HttpContext>()))
