...
namespace Standards.Infrastructure.Data
{
    public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Seeding data
            var housing1 = new Housing { Id = 1, Name = "Housing1", ShortName = "h1", FloorsCount = 2, Address = "Address1", Comments = "Comments1" };
            var housing2 = new Housing { Id = 2, Name = "Housing2", ShortName = "h2", FloorsCount = 1, Address = "Address2", Comments = "Comments2" };
            var housing3 = new Housing { Id = 3, Name = "Housing3", ShortName = "h3", FloorsCount = 2, Address = "Address3", Comments = "Comments3" };
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { Id = 2, Name = "Вторая квалификационная категория", ShortName = "2 категория", Comments = "Comments1" },
                new Category { Id = 3, Name = "Первая квалификационная категория", ShortName = "1 категория", Comments = "Comments1" },
